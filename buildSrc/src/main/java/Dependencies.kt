...
object Libraries {
    ...
    object Application {
        ...
        const val RUNTIME_LIFECYCLE = "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.RUNTIME_LIFECYCLE}"
        const val ACTIVITY_COMPOSE = "androidx.activity:activity-compose:${Versions.ACTIVITY_COMPOSE}"
        const val COMPOSE_UI = "androidx.compose.ui:ui:${Versions.COMPOSE_UI}"
        const val COMPOSE_UI_PREVIEW_TOOLING = "androidx.compose.ui:ui-tooling-preview:${Versions.COMPOSE_UI_PREVIEW_TOOLING}"
        const val COMPOSE_UI_MATERIAL_THREE = "androidx.compose.material3:material3:${Versions.COMPOSE_MATERIAL_THREE}"
    }
    ...
    object Test {
        ...
        const val ANDROID_ESPRESSO_CORE = "androidx.test.espresso:espresso-core:${Versions.ANDROID_ESPRESSO_CORE}"
        const val ANDROID_COMPOSE_UI_TEST_JUNIT = "androidx.compose.ui:ui-test-junit4:${Versions.ANDROID_COMPOSE_UI_TEST_JUNIT}"
        const val DEBUG_UI_TOOLING = "androidx.compose.ui:ui-tooling:${Versions.DEBUG_UI_TOOLING}"
        const val DEBUG_COMPOSE_TEST_MANIFEST = "androidx.compose.ui:ui-test-manifest:${Versions.DEBUG_COMPOSE_TEST_MANIFEST}"
    }
}